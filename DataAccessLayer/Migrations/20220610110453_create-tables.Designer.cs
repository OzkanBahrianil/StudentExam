...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20220610110453_create-tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrate.ExtendedLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("EventId")
                        .HasDatabaseName("IX_Log_EventId");
            ...
            modelBuilder.Entity("EntityLayer.Concrate.Student", b =>
                {
                    ...
                    b.Property<string>("studentFacultyName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EntityLayer.Concrate.Student", b =>
                {
                    b.HasOne("EntityLayer.Concrate.AppUser", "User")
                        .WithOne("Students")
                        .HasForeignKey("EntityLayer.Concrate.Student", "UserID")
